...
class ListaEditoriales(Resource):
    ...
    def post(self):
        ...
        if len(resultado)==0:
            ...
            return jsonify({"mensaje": "Editorial agregado con éxito"})
        else:
...
class Editorial(Resource):
    def get(self, idEditorial):
        ...
        if len(resultado)==0:
            return jsonify({"mensaje": "Editorial no encontrado!!!"})
        else:
            return jsonify({"mensaje":"Editorial encontrado","editorial":resultado[0]})
    ...
    def put(self, idEditorial):
        ...
        if len(resultado)==0:
            ...
            mis_editoriales.modificar(idEditorial, nuevo["nombre"], nuevo["idPais"])
            return jsonify({"mensaje": "Editorial modificado con éxito"})
    ...
    def delete(self, idEditorial):
        ...
        if len(resultado)==0:
            ...
            return jsonify({"mensaje": "Editorial eliminado con éxito"})
