from Biblioteca.Services.Autores.conexion import *
from Biblioteca.Services.Autores.autores import mis_autores
...
class Autor(Resource):
    ...
    def put(self, idAutor):
        ...
        if len(resultado)==0:
            ...
            mis_autores.modificar(idAutor, nuevo["nombre"], nuevo["email"], nuevo["idPais"])
